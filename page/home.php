...
<div class="container mt-4">
    <div class="row">
        <p class="text-center text-huruf col-5 kataKata">
            Selamat datang, selamat berbelanja di KyuuDent_Store. 
            Kami menyediakan beberapa peralatan sekolah dan kuliah anda seperti : 
            pulpen, pensil, dll. <br> Kamu bisa mendapatkan barang hanya dengan sekali tekan,
             dan kami akan mengirimkan barang yang kamu pesan dihari yang sama, 
             jangan khawatir, toko kami gratis pengiriman keseluruh Indonesia.
        </p>
    </div>
    <div class="row">
        <?php
